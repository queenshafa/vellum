    ...
    <div
        ...
        <div class="w-full max-w-lg">
            ...
            <form class="w-full max-w-lg" action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-5">
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="password_confirmation" class="block text-sm font-600 text-gray-700">Confirm
                            Password</label>
                    </div>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-3.5 flex items-center pointer-events-none">
                ...
                <p class="text-gray-400 text-center mt-4">Have an account? <a href="{{ route('login') }}"
