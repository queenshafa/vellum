...
{{-- 1. This goes straight into your banner layout title area --}}
@section('banner-title', 'Categories')

{{-- 2. This goes into your banner subtitle area --}}
@section('banner-subtitle')
    Let's capture your thoughts and stay on top of everything.
@endsection

{{-- 3. The "Add Category" button lives up in the banner action corner --}}
...
<body class="bg-white">
            ...
            <main class="flex-1 flex flex-col overflow-hidden">
                <div class="relative overflow-hidden shrink-0 rounded-tl-[3rem]" style="height: 220px;">
                    ...
                    <div class="relative z-10 flex justify-between items-start h-full px-10 pb-8 mt-16">
                        ...
                        <button
                            id="openModal"class="self-start mt-1 inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary/80 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                            </svg>
                        ...
                        <div class="flex flex-col gap-3">
                            @foreach ($categories as $category)
                                <div
                                    ...
                                    <a href="{{ route('notes.view', $category->id) }}"
                                        class="inline-flex items-center gap-1.5 px-2 py-1 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary/80 transition">
                                        <i class="ri-arrow-right-line text-xl"></i>
                                    </a>
                                </div>
    ...
    <!-- Modal Add Category -->
    <form id="categoryModal" method="POST" action="{{ route('category.store') }}"
        ...
        <div class="bg-white w-[420px] rounded-[20px] border-2 border-gray-300 p-8 shadow-xl">
            ...
            <div class="flex justify-between gap-3 py-2">
                <button type="button" id="closeModal"
                    class="bg-gray-300 text-gray-700 px-20 py-2 rounded-lg text-sm">
                    Cancel
                </button>
